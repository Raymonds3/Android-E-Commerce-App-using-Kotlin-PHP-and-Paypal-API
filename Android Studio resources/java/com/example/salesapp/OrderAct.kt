...
class OrderAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var url="http://192.168.8.101:81/SalesApp/get_temp.php?mobile="+UserInfo.mobile
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        ...
        {
            var url="http://192.168.8.101:81/SalesApp/cancel_order.php?mobile="+UserInfo.mobile
        ...
        {
            var url="http://192.168.8.101:81/SalesApp/confirm_order.php?mobile="+UserInfo.mobile
