    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reg_signup.setOnClickListener {
            ...
            if(reg_password.text.toString().equals(reg_confirm.text.toString())) {
                var url ="http://192.168.8.101:81/SalesApp/add_user.php?mobile="+reg_mobile.text.toString()+"&password="+reg_password.text.toString()+"&name="+reg_name.text.toString()+"&address="+reg_address.text.toString()
